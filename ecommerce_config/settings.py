...
SECRET_KEY = 'django-insecure-jfi!m1jf35%%c!6mm@75^y^sy-c==cy&i_2c@saa3gk&@9g&c+'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'store.context_processors.cart',  # Add this line to include the cart context processor
            ],
        },
    },
]
